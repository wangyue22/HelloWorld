...
public class CacheConsts {
    ...
    public interface JVM{
        ...
        /* rnfs_cfg分组上传配置信息 */
        String GROUP_RNFS_CFG_PREFIX = "RNFS_CFG:";

        /* rnfs_cfg 根据url前缀获取ftp配置 例如：aFtp */
        String FTP_CFG_PREFIX = "RNFS_CFG:";

        /* rnfs_cfg分组上传配置信息 */
        String RNFS_USERNAME_PWD = "RNFS_CFG:RNFS_USERNAME_PASSWORD";

        /* rnfs_cfg分组上传配置信息 */
        String RNFS_TIME_OUT = "RNFS_CFG:RNFS_TIME_OUT";

        /* 业务图片上传 区分使用onest 或者 rnfs/ftp */
        String ONEST_UPDOWN_FILE_FALG = "FILE_SWITCH:IS_ONEST_UPDOWN";
    }
